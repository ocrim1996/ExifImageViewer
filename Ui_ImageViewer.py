...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Icons/left_rotate_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.left_rotate_btn.setIcon(icon)
        self.left_rotate_btn.setIconSize(QtCore.QSize(30, 30))
        self.left_rotate_btn.setObjectName("left_rotate_btn")
        self.gridLayout.addWidget(self.left_rotate_btn, 0, 10, 1, 1)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Icons/right_rotate_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.right_rotate_btn.setIcon(icon1)
        self.right_rotate_btn.setIconSize(QtCore.QSize(30, 30))
        self.right_rotate_btn.setObjectName("right_rotate_btn")
        self.gridLayout.addWidget(self.right_rotate_btn, 0, 11, 1, 1)
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Icons/clear_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Icons/info_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.get_info_btn.setIcon(icon3)
        self.get_info_btn.setIconSize(QtCore.QSize(24, 24))
        self.get_info_btn.setObjectName("get_info_btn")
        self.gridLayout.addWidget(self.get_info_btn, 2, 10, 1, 1)
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Icons/image_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add_image_btn.setIcon(icon5)
        self.add_image_btn.setIconSize(QtCore.QSize(24, 24))
        self.add_image_btn.setObjectName("add_image_btn")
        self.gridLayout.addWidget(self.add_image_btn, 2, 11, 1, 1)
...
"}")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("Icons/location_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.geo_location_btn.setIcon(icon6)
        self.geo_location_btn.setIconSize(QtCore.QSize(24, 24))
        self.geo_location_btn.setObjectName("geo_location_btn")
        self.gridLayout.addWidget(self.geo_location_btn, 0, 9, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 0, 2, 1, 7)
...
"border-radius: 8px;")
        ...
        self.gridLayout.addWidget(self.image_viewer, 1, 2, 1, 10)
